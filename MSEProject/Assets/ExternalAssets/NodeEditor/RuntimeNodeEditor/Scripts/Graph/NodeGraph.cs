...
namespace RuntimeNodeEditor
{
    public class NodeGraph : MonoBehaviour
    {
        ...
        public void LoadFileByJson(string jsonData)
        {
            var graph = JsonUtility.FromJson<GraphData>(jsonData);
