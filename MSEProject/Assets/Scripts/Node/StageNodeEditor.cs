...
public class StageNodeEditor : NodeEditor
{
    ...
    private void OnConnect(SocketInput arg1, SocketOutput arg2)
    {
        ...
        DungeonEditor.Instance.editingDungeon.stages[arg1.OwnerNode.IdentifierID].prevStageID.Add(arg2.OwnerNode.IdentifierID);
        DungeonEditor.Instance.editingDungeon.stages[arg2.OwnerNode.IdentifierID].nextStageID.Add(arg1.OwnerNode.IdentifierID);
    ...
    public void SaveDungeonGraph()
    {
        switch (thisEditorSaveType)
        {
            ...
            {
                string tempSavePath = Application.dataPath + "/Resources/" + DungeonEditor.Instance.editingDungeon.id + "graph.json";
    ...
    public void LoadDungeonGraph()
    {
        switch (thisEditorSaveType)
        {
            case StageNodeEditorSaveType.Local:
            {
                string tempLoadPath = Application.dataPath + "/Resources/" + DungeonEditor.Instance.editingDungeon.id + "graph.json";
